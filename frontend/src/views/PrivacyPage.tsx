            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <div className="flex justify-center mb-4">
                        <Shield className="h-12 w-12 text-brand-lime" />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 sm:p-12 prose prose-blue prose-lg max-w-none text-gray-600">
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">1. Información que Recopilamos</h3>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">2. Uso de tu Información</h3>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">3. Compartir Información</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">4. Seguridad de los Datos</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">5. Tus Derechos</h3>
                    <p>
