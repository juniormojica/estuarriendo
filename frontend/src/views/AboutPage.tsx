        ...
        <div className="bg-gray-50 min-h-screen py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-base text-brand-lime font-jakarta font-bold tracking-wide uppercase">Nuestra Historia</h2>
                    <p className="mt-2 text-3xl leading-8 font-jakarta font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        Sobre Nosotros
                    </p>
                    <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto font-lato">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden mb-16">
                    <div className="p-8 sm:p-12">
                        <div className="prose prose-blue prose-lg text-gray-600 mx-auto font-lato">
                            <p>
                            ...
                            <h3 className="font-jakarta font-bold text-gray-900">Nuestra Visión</h3>
                            <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* Value 1 */}
                    <div className="bg-white rounded-xl shadow-sm p-6 text-center border border-gray-100 hover:shadow-md transition-shadow">
                        <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-brand-blue/10 mb-4">
                            <Shield className="h-6 w-6 text-brand-blue" />
                        </div>
                        <h3 className="text-lg font-jakarta font-bold text-gray-900 mb-2">Seguridad Primero</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 text-center border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <h3 className="text-lg font-jakarta font-bold text-gray-900 mb-2">Comunidad</h3>
                        <p className="text-gray-500 text-sm font-lato">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 text-center border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <h3 className="text-lg font-jakarta font-bold text-gray-900 mb-2">Simplicidad</h3>
                        <p className="text-gray-500 text-sm font-lato">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 text-center border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <h3 className="text-lg font-jakarta font-bold text-gray-900 mb-2">Calidad</h3>
                        <p className="text-gray-500 text-sm font-lato">
