            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <div className="flex justify-center mb-4">
                        <FileText className="h-12 w-12 text-brand-lime" />
                    </div>
                    <h2 className="text-3xl font-jakarta font-extrabold text-gray-900 sm:text-4xl">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 sm:p-12 prose prose-blue prose-lg max-w-none text-gray-600">
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">1. Naturaleza del Servicio</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">2. Responsabilidades de los Usuarios</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">3. Políticas de Publicación</h3>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">4. Privacidad y Datos</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">5. Limitación de Responsabilidad</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">6. Modificaciones de los Términos</h3>
                    <p>
