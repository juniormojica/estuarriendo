        ...
        <div className="bg-gray-50 min-h-screen py-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-base text-brand-blue font-semibold tracking-wide uppercase">Guía Paso a Paso</h2>
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 bg-white p-8 rounded-xl shadow-sm">
                        <div className="flex-shrink-0">
                            <div className="flex items-center justify-center h-16 w-16 rounded-full bg-brand-lime/20 text-brand-blue">
                                <Search className="h-8 w-8" />
                            </div>
                        </div>
                        <div>
                            <h3 className="text-2xl font-jakarta font-bold text-gray-900 mb-3">1. Explora las opciones</h3>
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 bg-white p-8 rounded-xl shadow-sm">
                        ...
                        <div>
                            <h3 className="text-2xl font-jakarta font-bold text-gray-900 mb-3">2. Usa los filtros inteligentes</h3>
                            <p className="text-gray-600 text-lg">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 bg-white p-8 rounded-xl shadow-sm">
                        ...
                        <div>
                            <h3 className="text-2xl font-jakarta font-bold text-gray-900 mb-3">3. Revisa los detalles</h3>
                            <p className="text-gray-600 text-lg">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 bg-white p-8 rounded-xl shadow-sm">
                        ...
                        <div>
                            <h3 className="text-2xl font-jakarta font-bold text-gray-900 mb-3">4. Contacta y reserva</h3>
                            <p className="text-gray-600 text-lg">
