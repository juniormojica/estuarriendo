            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <div className="flex justify-center mb-4">
                        <Cookie className="h-12 w-12 text-brand-lime" />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 sm:p-12 prose prose-blue prose-lg max-w-none text-gray-600">
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">¿Qué son las cookies?</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">Tipos de Cookies que Utilizamos</h3>
                    ...
                    <h3 className="text-xl font-jakarta font-bold text-gray-900 mt-8 mb-4">Control de Cookies</h3>
                    <p>
