            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
                ...
                <div className="flex items-center space-x-2.5 sm:space-x-3 mb-6 sm:mb-8">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-2xl sm:text-3xl font-jakarta font-bold text-gray-900">Mis Favoritos</h1>
                ...
                {properties.length > 0 ? (
                    ...
                    <div className="text-center py-12 sm:py-16 px-4 bg-white rounded-xl shadow-sm border border-gray-100">
                        <Heart className="h-12 w-12 sm:h-16 sm:w-16 text-gray-300 mx-auto mb-3 sm:mb-4" />
                        <h2 className="text-lg sm:text-xl font-jakarta font-semibold text-gray-900 mb-2">No tienes favoritos aún</h2>
                        <p className="text-sm sm:text-base text-gray-500 mb-6 sm:mb-8 max-w-md mx-auto font-lato">
                            Guarda las propiedades que te interesen haciendo clic en el corazón para verlas aquí.
                        </p>
                        <Link
                            href="/"
                            className="inline-flex items-center min-h-[48px] px-6 py-3 border border-transparent text-sm sm:text-base font-jakarta font-bold rounded-lg shadow-sm text-white bg-brand-blue hover:bg-brand-blue/90 active:bg-brand-dark transition-colors"
                        >
